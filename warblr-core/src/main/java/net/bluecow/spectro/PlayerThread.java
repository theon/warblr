...
public class PlayerThread extends Thread {
     ...
     */
    public void setPlaybackPosition(int sample) {
        setPlaybackPosition(sample, Integer.MAX_VALUE);
    }

    public synchronized void setPlaybackPosition(int sample, int length) {
        if (in != null) {
            try {
                in.close();
        ...
        startSample = sample;
        in = clip.getAudio(sample, length);
        firePlaybackPositionUpdate(getPlaybackPosition());
    }
