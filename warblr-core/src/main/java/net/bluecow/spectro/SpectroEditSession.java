...
public class SpectroEditSession {
    ...
    protected SpectroEditSession(Clip c, String title) throws LineUnavailableException {
        ...
        final JFrame f = new JFrame("Spectro-Edit " + Version.VERSION + " - " + title);
    ...
    public static SpectroEditSession createSession(Clip c) throws LineUnavailableException {
        SpectroEditSession session = new SpectroEditSession(c, c.getName());
