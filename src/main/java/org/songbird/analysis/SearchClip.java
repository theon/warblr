...
public class SearchClip extends AnalysedClip {
    ...
    public SearchClip(Clip clip, final int lowPassFrequencyThreshold, final int highPassFrequencyThreshold) {
    ...
    protected void handlePeak(int frame, int frequency, double amplitude) {
        peaks[frame][frequency - lowPassFrequencyThreshold] = (int)(amplitude * 100);
    }
